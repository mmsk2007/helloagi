...
3. Add malformed/multiple-event replay tests for context-workspace diagnostics.
4. Strengthen Gemini parity with a mocked end-to-end tool-call/journal assertion.
5. Add a shared helper for provider-loop context-gate result rendering to reduce duplication across Anthropic/OpenAI/Gemini.
