...
RESEARCH = PolicyPack(
    ...
    allowed_tools=["web_search", "web_fetch", "file_read", "file_write", "file_search",
                    ...
                    "reminder_pause", "reminder_resume", "reminder_run_now"],
    model_tier="quality",
...
CODER = PolicyPack(
    ...
    allowed_tools=["bash_exec", "file_read", "file_write", "file_patch", "file_search",
                    ...
                    "delegate_task", "session_search", "reminder_create", "reminder_list",
                    "reminder_cancel", "reminder_pause", "reminder_resume", "reminder_run_now"],
    model_tier="balanced",
